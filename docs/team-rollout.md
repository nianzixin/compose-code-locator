...
The staged release also includes `README.md`, `docs/team-rollout.md`, `docs/release-engineering.md`, and `docs/compatibility-matrix.json` so the internal package can be distributed as a self-contained onboarding bundle.
